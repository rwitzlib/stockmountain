...
| 19 | [19-strategy-research-backlog.md](19-strategy-research-backlog.md) | research backlog (2026-09-04): diagnostics of the live RSI-low bot + best backtest (Hold vs hindsight High, live stop slippage, MAE split), 30 backtestable-today filter sets, 22 strategies blocked on missing capabilities (cross-refs plan 11), engine/tooling asks (slippage model, 5m in backtests, param sweeps, per-ticker cap) | none — idea backlog; implementers pick items into plan 11 / new plans |
